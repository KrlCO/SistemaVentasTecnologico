    ...
    public class CD_Marca
    {
        ...
        public List<Marca> Listar()
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    ...
                    SqlCommand cmd = new SqlCommand("sp_ListMark", oconexion);
        ...
        public int Registrar(Marca obj, out string Mensaje)
        {
            ...
            try
            {
                ...
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    SqlCommand cmd = new SqlCommand("sp_SaveMark", oconexion);
        ...
        public bool Editar(Marca obj, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    SqlCommand cmd = new SqlCommand("sp_EditMark", oconexion);
        ...
        public bool Eliminar(int id, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    SqlCommand cmd = new SqlCommand("sp_DeleteMark", oconexion);
